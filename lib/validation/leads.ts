...
export const discoveryCallSchema = z.object({
  ...
  hasCmsAccess: z.boolean().optional(),
  hasHostingAccess: z.boolean().optional(),
  hasGscAccess: z.boolean().optional(),
  revenueSplit: z.string().optional(),
  targetCities: z.string().optional(),
  avgJobValue: z.string().optional(),
  closeRate: z.string().optional(),
  serviceCapacity: z.string().optional(),
  leadSources: z.string().optional(),
  reputationNotes: z.string().optional(),
